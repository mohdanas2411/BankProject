public class YES_Bank extends MyBank{

//    @Override
//    public void withdraw(Account acc, Double amount) {
//        if (amount < acc.getMinWithdraw())
//            System.out.println("Minimum Withdraw amount limit is " + acc.getMinWithdraw());
//
//        else if (amount > acc.getMaxWithdraw())
//            System.out.println("Maximum Withdraw amount limit is " + acc.getMaxWithdraw());
//
//        else {
...
//            System.out.println("Minimum Deposit amount limit is : " + acc.getMinDeposit());
//
//        else if (amount > acc.getMaxDeposit())
//            System.out.println("Maximum Deposit amount limit is : " + acc.getMaxDeposit());
//
//        else {
//
